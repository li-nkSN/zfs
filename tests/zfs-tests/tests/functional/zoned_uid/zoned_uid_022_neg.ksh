...
fs_limit=$(zfs get -H -p -o value filesystem_limit "$TESTPOOL/$TESTFS/deleg_root")
snap_limit=$(zfs get -H -p -o value snapshot_limit "$TESTPOOL/$TESTFS/deleg_root")
...
child_fs_limit=$(zfs get -H -p -o value filesystem_limit \
    "$TESTPOOL/$TESTFS/deleg_root/child")
child_snap_limit=$(zfs get -H -p -o value snapshot_limit \
    "$TESTPOOL/$TESTFS/deleg_root/child")
